...
一个能自动生成中国学生个人基础信息（name、gender、birthday）的 Python 包。
...
[ver0.3.1](https://alt-generate-zh-name.readthedocs.io/zh-cn/ver0.3.1/)  
...
**返回**：`pandas.DataFrame`，列为 `["name", "gender", "birthday"]`。
